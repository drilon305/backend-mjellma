...
module.exports = {
  async frequency() {
    ...
    async confirmationEmail(order) {
              ...
              <table class="row" width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="width:700px;max-width:700px;" bgcolor="#ffffff">
                <tbody><tr>
                  <td align="center" valign="middle" style="padding:0;">
                    <a href=""><img data-crop="false" mc:hideable="" mc:edit="" src="https://i.ibb.co/b7Yq3xf/dssport.png" alt="#" border="0" width="100%" style="display:block;border:0;width:100%;"></a>
                  </td>
                </tr>
              </tbody></table>
            </td>
        ...
        email at <a href="mailto:support@dssport.com" style="color: #99B898; text-decoration: none;">support@dssport.com</a>
                        </td>
                      </tr>
                      <tr>
                        <td height="10" align="center" valign="top" style="font-size:10px;line-height:10px;">&nbsp;</td>
